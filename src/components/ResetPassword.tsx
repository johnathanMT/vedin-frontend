      ...
      <div className="glass-card w-full max-w-sm p-6">
        ...
        {done ? (
          <div className="mt-4 text-center">
            ...
            <Link to={signInHref} className="mt-5 inline-block rounded-xl bg-amber-600 shadow-md px-5 py-2.5 text-sm font-semibold text-amber-50 transition hover:brightness-110">Go to sign in</Link>
          </div>
        ) : (
          <>
