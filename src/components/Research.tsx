    ...
    <section className="section-container vedin-page">
      ...
      <div className="glass-card mb-6 p-6">
        ...
        <form onSubmit={addPrediction} className="grid gap-3 sm:grid-cols-2">
          ...
          <button type="submit" className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-accent to-violet-500 px-5 py-2.5 text-sm font-semibold text-space transition hover:brightness-110 sm:col-span-2"><Lock size={15} /> {t('Lock prediction', 'ဟောကိန်းကို Lock ချ၍ သိမ်းမည်')}</button>
        </form>
      </div>
